...
const phrases = {
    greetings: 'Доброго дня. Я бот Таксі, я допоможу Вам підібрати поїздку, зарезервувати місце та оплатити квитки. Авторизуйтеся для доступу до функціоналу, для цього скористайтеся кнопкою "Поділитися номером телефону" внизу екрана"',
    ...
    welcomeNoCard: 'Шановний клієнте, дякуємо за авторизацію. Ви вже можете користуватися всіма функціями бота: зарезервувати та оплатити поїздку. Переглянути маршрути.',
